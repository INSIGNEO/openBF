...
ax1.plot(P[:,0], P[:,3]/1000, 'k', linestyle="--", label="AM")
...
ax2.plot(Q[:,0], Q[:,3]*1e6, 'k', linestyle="--")
...
ax3.plot(A[:,0], dR*1e3, 'k', linestyle="--")
...
ax4.plot(P[:,0], P[:,-1]/1000, 'k', linestyle="--")
...
ax5.plot(Q[:,0], Q[:,-1]*1e6, 'k', linestyle="--")
...
ax6.plot(A[:,0], dRb*1e3, 'k', linestyle="--")
...
ax7.plot(P1[:,0], P1[:,3]/1000, 'k', linestyle="--")
...
ax8.plot(Q1[:,0], Q1[:,3]*1e6, 'k', linestyle="--")
...
ax9.plot(A1[:,0], dR1*1e3, 'k', linestyle="--")
