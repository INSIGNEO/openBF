...
\*nix: [![Build Status](https://travis-ci.org/INSIGNEO/openBF.svg?branch=master)](https://travis-ci.org/INSIGNEO/openBF)

Windows: [![Build Status](https://img.shields.io/badge/build-fails-red.svg)](https://github.com/INSIGNEO/openBF/issues/7)
