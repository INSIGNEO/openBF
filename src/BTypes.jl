...
type  Vessel
  ...
  temp_P_name :: ASCIIString
  temp_Q_name :: ASCIIString
  temp_A_name :: ASCIIString
  temp_c_name :: ASCIIString
  temp_u_name :: ASCIIString

  last_P_name :: ASCIIString
  last_Q_name :: ASCIIString
  last_A_name :: ASCIIString
  last_c_name :: ASCIIString
  last_u_name :: ASCIIString

  #Output files name
  out_P_name :: ASCIIString
  out_Q_name :: ASCIIString
  out_A_name :: ASCIIString
  out_c_name :: ASCIIString
  out_u_name :: ASCIIString
