...
function solveAnastomosis(v1 :: Vessel, v2 :: Vessel, v3 :: Vessel)
  ...
  J = calculateJacobianAnastomosis(v1, v2, v3, U, k)
  U = newtonRaphson(J, v1, v2, v3, U, k, calculateWstarAnastomosis, calculateFAnastomosis)
...
#   return [W1, W2, W3]
# end
function calculateWstarAnastomosis(U :: Array, k :: Array)
...
# end
function calculateFAnastomosis(v1 :: Vessel, v2 :: Vessel, v3 :: Vessel,
                               U :: Array,   k :: Array,   W :: Array)
...
function calculateJacobianAnastomosis(v1 :: Vessel, v2 :: Vessel, v3 :: Vessel,
                                      U :: Array,   k :: Array)
...
function updateAnastomosis(U :: Array, v1 :: Vessel, v2 :: Vessel, v3 :: Vessel)
    v1.u[end] = U[1]
    v2.u[end] = U[2]
    v3.u[1] = U[3]
